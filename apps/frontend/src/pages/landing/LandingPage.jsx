  ...
  const handleTierCta = (tier) => () => {
    ...
    if (tier.custom) {
      if (isCalcomConfigured()) {
        ...
        window.location.href = "mailto:hello@biteperk.com.au?subject=VoxTable%20Enterprise%20%C2%B7%20scoping%20call";
      }
      return;
    }
    ...
    <div className="lp-shell">
      <nav className={`lp-nav ${scrolled ? "lp-scrolled" : ""}`}>
        <div className="lp-wrap lp-nav-inner">
          <button className="lp-brand" onClick={() => navigate("/")} aria-label="VoxTable home">
            <span className="lp-mark">
              <BiteperkMark size={42} />
            </span>
            <span className="lp-brand-name">
              Vox<span className="lp-mist" style={{ fontWeight: 300 }}>Table</span>
            </span>
          </button>
              ...
              <div className="lp-hero-card-stage">
                <picture className="lp-hero-card-photo">
                  ...
                  <img
                    ...
                    width="720"
                    height="900"
                    alt="Bella, VoxTable's AI phone host, wearing a headset against the Australian flag"
                    fetchPriority="high"
                    loading="eager"
                    decoding="async"
                  />
      ...
      <div className="lp-trust">
        <div className="lp-wrap lp-trust-inner">
          ...
          <span style={{ color: "#41464e" }}>•</span>
          <span>Powered by VoxTable voice AI</span>
        </div>
      </div>
            ...
            <div className="lp-bella-card" role="img" aria-label="Bella, the AI phone host">
              <picture className="lp-bella-card-photo">
                ...
                <img
                  ...
                  width="720"
                  height="720"
                  alt="Bella, VoxTable's AI phone host, in profile against the Australian flag"
                  loading="lazy"
                  decoding="async"
                />
              </picture>
        ...
        <div className="lp-wrap">
          ...
          <div className="lp-steps">
            ...
            <div className="lp-step lp-reveal">
              ...
              <p>Every call and reservation lands in your VoxTable dashboard in real time.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="lp-footer">
        <div className="lp-wrap">
          <div className="lp-foot-inner">
            <div className="lp-foot-brand">
              ...
              <a
                ...
                href={PRODUCT_URL}
                rel="noopener"
                aria-label="VoxTable on biteperk.com.au — the company behind VoxTable"
              >
                <span>A</span>
                <img
            ...
            <div className="lp-foot-cols">
              ...
              <div className="lp-foot-col">
                <h4>BitePerk</h4>
                <a href={PRODUCT_URL} rel="noopener">VoxTable on biteperk.com.au</a>
          ...
          <div className="lp-foot-bottom">
            ...
            <div>VoxTable · Voice AI booking for restaurants · Sydney, Australia</div>
          </div>
        </div>
      </footer>
